...
#         valid_loss_min,
#         valid_loss))
#         torch.save(model.state_dict(), 'model_2_linear.pt')
...
# np.save('model_2_layer_linear_accuracy.npy', np.array(epoch_accuracy))
# %%
model.load_state_dict(torch.load('model_2_linear.pt'))
